...
public class PipeJunctionItemRenderer implements IItemRenderer
{
    ...
    public PipeJunctionItemRenderer()
    {
        model = new PipeModel();
    }
    ...
    private void renderJunction(ImmutableTriple<Float, Float, Float> offset)
    {
        ...
        FMLClientHandler.instance().getClient().renderEngine.bindTexture(PipeTESR.TEXTURE_JUNCTION_BOX);
