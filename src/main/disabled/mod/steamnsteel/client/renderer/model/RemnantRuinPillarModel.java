...
public class RemnantRuinPillarModel extends SteamNSteelModel
{
    private static final ResourceLocation MODEL = getResourceLocation(getModelPath(RemnantRuinPillarBlock.NAME));
    private final IModelCustom model;

    public RemnantRuinPillarModel()
    {
