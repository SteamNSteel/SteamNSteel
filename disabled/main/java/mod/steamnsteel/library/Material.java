...
{
    BRONZE(addArmorMaterial("bronze", Reference.ArmourTextures.BRONZE, 11, new int[]{2, 6, 4, 2}, 9, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.0f),
            addToolMaterial("bronze", 2, 250, 5.0F, 1.5F, 14)),
    STEEL(addArmorMaterial("steel", Reference.ArmourTextures.STEEL, 24, new int[]{3, 7, 6, 3}, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1.0f),
